...
/* 08) Em um país imaginário denominado Lisarb, todos os
habitantes ficam felizes em pagar seus impostos, pois sabem
que nele não existem políticos corruptos e os recursos
arrecadados são utilizados em benefício da população, sem
qualquer desvio. A moeda deste país é o Rombus, cujo símbolo
é o R$. Leia um valor com duas casas decimais, equivalente ao
...
public class exercicio_proposto_08 {
	...
	public static void main(String[] args) {
		...
		if (salario == 0.0 || salario <= 2000.0) {
			...
			ir = (salario - 3000.0) * 0.18 + 0.08 * 1000.0;
			
		}
		else if (salario > 4500.0) {
			ir = (salario - 4500.0) * 0.28 + 1500.0 * 0.18 + 0.08 * 1000.0; 
		}
